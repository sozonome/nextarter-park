<img src="https://og.sznm.dev/api/generate?heading=nextarter-park&text=Next.js+(App+Router)+template+with+Park%20UI%20(Ark%20UI%20and%20PandaCSS)+and+TypeScript+setup.&template=color&center=true&height=320" />
